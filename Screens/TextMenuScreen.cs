...
namespace Parkour2D360.Screens
{
    ...
    public abstract class TextMenuScreen : MenuScreen
    {
        ...
        protected TextMenuScreen(string menuTitle)
            : base(menuTitle)
        {
        ...
        protected virtual void UpdateMenuEntryLocations()
        {
            ...
            foreach (var menuEntry in _menuEntries)
            {
                ...
                position.X =
                    ScreenManager.GraphicsDevice.Viewport.Width / 2 - menuEntry.GetWidth(this) / 2;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            var titleColor = new Color(75, 75, 75) * TransitionAlpha;
