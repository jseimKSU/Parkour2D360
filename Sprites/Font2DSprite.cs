...
namespace Parkour2D360.Sprites
{
    public class Font2DSprite
    {
        ...
        public Font2DSprite()
        {
            ...
            Hitbox = new BoundingRectangle(_position, SPRITE_WIDTH * 2 * SPRITE_SCALE_FACTOR, SPRITE_HEIGHT * SPRITE_SCALE_FACTOR);
        }
        ...
        {
            spriteBatch.Draw(_texture, _position, _2Rectangle, Color.White, 0, new Vector2(0, 0), 10f, SpriteEffects.None, 0);
            spriteBatch.Draw(_texture, new Vector2(_position.X + (SPRITE_SCALE_FACTOR * 10), _position.Y), _DRectangle, Color.White, 0, new Vector2(0, 0), SPRITE_SCALE_FACTOR, SpriteEffects.None, 0);
        }
    }
}
